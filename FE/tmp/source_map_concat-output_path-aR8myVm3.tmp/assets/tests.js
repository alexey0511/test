...
define('groom-clients-ember/tests/pods/order/manage-client-selection/component.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - pods/order/manage-client-selection');
  QUnit.test('pods/order/manage-client-selection/component.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'pods/order/manage-client-selection/component.js should pass jshint.');
  });
});
...
define('groom-clients-ember/tests/pods/order/route.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - pods/order');
  QUnit.test('pods/order/route.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'pods/order/route.js should pass jshint.');
  });
});
define('groom-clients-ember/tests/pods/order/select-client/component.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - pods/order/select-client');
  QUnit.test('pods/order/select-client/component.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'pods/order/select-client/component.js should pass jshint.');
  });
});
define('groom-clients-ember/tests/pods/order/small-client-new-form/component.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - pods/order/small-client-new-form');
  QUnit.test('pods/order/small-client-new-form/component.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'pods/order/small-client-new-form/component.js should pass jshint.');
  });
});
...
define('groom-clients-ember/tests/pods/report/model.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - pods/report');
  QUnit.test('pods/report/model.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'pods/report/model.js should pass jshint.');
  });
});
define('groom-clients-ember/tests/pods/report/route.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - pods/report');
  QUnit.test('pods/report/route.js should pass jshint', function (assert) {
    assert.expect(1);
...
define('groom-clients-ember/tests/pods/session-user/service.jshint', ['exports'], function (exports) {
  'use strict';

  QUnit.module('JSHint - pods/session-user');
  QUnit.test('pods/session-user/service.js should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(true, 'pods/session-user/service.js should pass jshint.');
  });
});
